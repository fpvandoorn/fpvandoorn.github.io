...
<!-- * *Oct 2024*: Maria, Michael and Arend joined the formalization group in Bonn. -->
...
<!-- * *Jun 2024*: I'm launching the formalization of Carleson's theorem. Take a look at [the project webpage](http://florisvandoorn.com/carleson/), or the [introductory presentation](https://www.youtube.com/watch?v=PNaOSAPtvv0). If you know some Lean, you are welcome to join the project. -->
...
## Publications
- Floris van Doorn, Heather Macbeth. [*Integrals Within Integrals: A Formalization of the Gagliardo-Nirenberg-Sobolev Inequality*](https://doi.org/10.4230/LIPIcs.ITP.2024.37), ITP 2024: Fifteenth Conference on Interactive Theorem Proving. ([slides](talks/ITP24Sobolev.pdf))
- Patrick Massot, Floris van Doorn, Oliver Nash. *["Formalising the *h*-principle and sphere eversion"](papers/sphere_eversion.pdf)*, CPP 2023: Certified Programs and Proofs. ([paper](https://dl.acm.org/doi/10.1145/3573105.3575688), [website](https://leanprover-community.github.io/sphere-eversion/), [slides](talks/sphere_eversion_CPP.pdf))
...
- Leonardo de Moura, Soonho Kong, Jeremy Avigad, Floris van Doorn, Jakob von Raumer. *["The Lean Theorem Prover (System Description)"](papers/lean_description.pdf)*, International Conference on Automated Deduction (CADE-25), 2015 ([Springer](https://link.springer.com/chapter/10.1007/978-3-319-21401-6_26)). This paper received the [**Skolem award**](https://cadeinc.org/Skolem-Award) in 2025.
